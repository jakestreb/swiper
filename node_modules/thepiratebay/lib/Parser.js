                ...
                requests = proxyUrls.map(function (_url) {
                  ...
                  return (
                    ...
                    (0, _isomorphicFetch2.default)(_url, options).then(function (response) {
                      ...
                      return body.includes('403 Forbidden') || body.includes('502: Bad gateway') || body.includes('Database maintenance') ? _promise2.default.reject('Database maintenance or 502 error') : _promise2.default.resolve(body);
                    })
                  );
                });
